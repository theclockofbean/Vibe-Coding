...
This script verifies POST /api/v1/quality/query.
...
class QualityAPICheckCase:
    """One quality API check case."""
...
def build_cases() -> list[QualityAPICheckCase]:
    """Return deterministic API check cases."""
...
def main() -> int:
    ...
    if not all(results):
        print("quality API check failed")
        return 1

    print("quality API check passed")
    return 0
