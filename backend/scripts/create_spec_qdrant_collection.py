"""Create or validate Qdrant collection for Spec KB."""
...
def main() -> int:
    """Create or validate Spec KB Qdrant collection."""

    print("=" * 80)
    print("creating or validating spec_kb_v1 Qdrant collection")
    ...
    if errors:
        print("spec_kb_v1 Qdrant collection check failed")
        return 1

    print("spec_kb_v1 Qdrant collection check passed")
    return 0
