"""Run Phase 3-I-H frontend payload total regression."""
...
CHECK_SCRIPTS: Final[tuple[str, ...]] = (
    "scripts/check_phase3ih_response_payload_baseline.py",
    "scripts/check_phase3ih_response_payload_answer_strategy_fields.py",
    "scripts/check_phase3ih_api_response_payload_regression.py",
    "scripts/check_phase3ih_frontend_payload_contract.py",
    "scripts/check_phase3ig_renderer_gate_total_regression.py",
)
...
def main() -> int:
    ...
    print("=" * 80)
    print("running Phase 3-I-H frontend payload total regression")
    ...
    if errors:
        print("Phase 3-I-H frontend payload total regression failed")
        return 1

    print("Phase 3-I-H frontend payload total regression passed")
    return 0
