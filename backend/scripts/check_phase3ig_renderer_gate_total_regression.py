"""Run Phase 3-I-G renderer gate total regression."""
...
CHECK_SCRIPTS: Final[tuple[str, ...]] = (
    "scripts/check_phase3ig_answer_strategy_json.py",
    "scripts/check_phase3ig_answer_strategy_helper.py",
    "scripts/check_phase3ig_workflow_answer_strategy_metadata.py",
    "scripts/check_phase3ig_renderer_answer_strategy_gate_design.py",
    "scripts/check_phase3ig_answer_strategy_render_gate.py",
    "scripts/check_phase3ig_answer_strategy_workflow_regression.py",
    "scripts/check_phase3if_total_regression.py",
)


def main() -> int:
    """Run renderer gate total regression."""

    print("=" * 80)
    print("running Phase 3-I-G renderer gate total regression")
    ...
    if errors:
        print("Phase 3-I-G renderer gate total regression failed")
        return 1

    print("Phase 3-I-G renderer gate total regression passed")
    return 0
