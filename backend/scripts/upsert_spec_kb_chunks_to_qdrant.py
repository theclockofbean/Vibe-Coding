# ruff: noqa: E402,I001
"""Upsert Spec KB chunks from PostgreSQL to Qdrant."""
...
def main() -> int:
    """Upsert Spec KB chunks to Qdrant."""

    print("=" * 80)
    print("upserting Spec KB chunks to Qdrant")

    set_required_env()

    errors: list[str] = []
    rows = load_spec_rows_from_postgres()
    ...
    if errors:
        print("Spec KB Qdrant upsert failed")
        return 1

    print("Spec KB Qdrant upsert passed")
    return 0
...
def load_spec_rows_from_postgres() -> list[dict[str, Any]]:
    """Load active Spec KB rows from PostgreSQL."""
    ...
    payload.update(
        {
            ...
            "source_name": row.get("source_name", "spec_questions.xlsx"),
