# Phase 3-I-C1｜真实 Logistics KB 接入设计 v0.1

## 1. 阶段目标

本阶段目标是将物流类问答文件接入真实 RAG 链路：
...
→ bge-m3 embedding
→ Qdrant logistics_kb_v1
→ LogisticsKBQdrantRetriever
→ Workflow RetrievalNode
→ GroundedRenderer E2E
Set-Location "D:\Projects\ai-knowledge-agent-platform\backend"

$targetFile = "D:\Projects\ai-knowledge-agent-platform\backend\scripts\check_logistics_questions_file.py"
...
SKU_MASTER_FILE: Final[Path] = PROJECT_ROOT / "data" / "uploads" / "sku_master.xlsx"
